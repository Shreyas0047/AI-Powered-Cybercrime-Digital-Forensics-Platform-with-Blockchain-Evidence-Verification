...
const HEURISTICS = [
    {
        ...
        category: threat_models_1.HeuristicCategory.FILE_BEHAVIOR,
        severity: 'high',
        weight: 25,
    ...
    },
    {
        ...
        category: threat_models_1.HeuristicCategory.PROCESS_ANOMALY,
        severity: 'medium',
        weight: 20,
        detect: (events, features) => {
    ...
    },
    {
        ...
        category: threat_models_1.HeuristicCategory.EXECUTION_PATTERN,
        severity: 'high',
        weight: 25,
        detect: (events, features) => {
    ...
    },
    {
        ...
        category: threat_models_1.HeuristicCategory.REGISTRY_PERSISTENCE,
        severity: 'high',
        weight: 25,
        detect: (events, features) => {
    ...
    },
    {
        ...
        category: threat_models_1.HeuristicCategory.NETWORK_PATTERN,
        severity: 'high',
        weight: 20,
        detect: (events, features) => {
    ...
    },
    {
        ...
        category: threat_models_1.HeuristicCategory.LATERAL_MOVEMENT,
        severity: 'high',
        weight: 20,
        detect: (events, features) => {
    ...
    },
    {
        ...
        category: threat_models_1.HeuristicCategory.RECONNAISSANCE,
        severity: 'medium',
        weight: 15,
        detect: (events, features) => {
            const scanEvents = events.filter(e => e.normalizedType.includes('scan') ||
                e.behavioralTags.includes('file_enumeration')).length;
...
class BehavioralHeuristicsEngine {
    analyzeHeuristics(events, features) {
        const results = [];
...
exports.BehavioralHeuristicsEngine = BehavioralHeuristicsEngine;
exports.behavioralHeuristicsEngine = new BehavioralHeuristicsEngine();
exports.default = exports.behavioralHeuristicsEngine;
//# sourceMappingURL=behavioral_heuristics.js.map