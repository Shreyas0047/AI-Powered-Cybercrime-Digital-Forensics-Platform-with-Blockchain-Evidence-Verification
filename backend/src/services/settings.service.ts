...
function validateSettings(settings: Partial<AppSettings>): { valid: boolean; errors: string[] } {
  const errors: string[] = [];
...
export class SettingsService {
  ...
  updateSettings(updates: Partial<AppSettings>): { settings: AppSettings; errors?: string[] } {
